...
function sw_download() {
	...
	case "${CURRENT_VM_ARCH}" in
		"arm64") swUrl="https://zunyun01.store.deepinos.org.cn/aarch64-store/office/wps-office/wps-office_11.1.0.11719_arm64.deb" ;;
		"amd64") swUrl="https://zunyun01.store.deepinos.org.cn/amd64-store/office/wps-office/wps-office_11.1.0.11719_plus_Mejituu-2024022119_amd64.deb" ;;
		*) exit_unsupport ;;
	esac
